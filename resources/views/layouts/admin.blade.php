        ...
        <section class="sidebar">
           ...
           <p>     {{ Auth::user()->name }}</p>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{route('admin.user')}}"><i class="fa fa-user-circle"></i> <span>All User</span></a></li>
                <li><a href="{{route('admin.category')}}"><i class="fa fa-list"></i> <span>Category</span></a></li>
